    ...
    SLAM_(SLAM)
{
    ...
    subImu_ = this->create_subscription<ImuMsg>("bcr_bot/imu", 1000, std::bind(&StereoInertialNode::GrabImu, this, _1));
    subImgLeft_ = this->create_subscription<ImageMsg>("bcr_bot/stereo_camera/left/image_raw", 100, std::bind(&StereoInertialNode::GrabImageLeft, this, _1));
    subImgRight_ = this->create_subscription<ImageMsg>("bcr_bot/stereo_camera/right/image_raw", 100, std::bind(&StereoInertialNode::GrabImageRight, this, _1));

    ...
    m_SLAM(pSLAM)
{
    ...
    left_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(shared_ptr<rclcpp::Node>(this), "bcr_bot/stereo_camera/left/image_raw");
    right_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(shared_ptr<rclcpp::Node>(this), "bcr_bot/stereo_camera/right/image_raw");

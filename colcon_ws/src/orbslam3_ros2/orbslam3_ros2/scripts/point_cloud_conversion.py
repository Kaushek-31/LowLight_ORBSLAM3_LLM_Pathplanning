...
if __name__ == "__main__":
    input_file = "/home/kaushek/MRob/colcon_ws/PointCloudData.txt" # ReferenceMapPoints seem to work better, use that file
    output_file = "./output.ply"
    img_output = "./grid_map.png"
    input_trajectory = "/home/kaushek/MRob/colcon_ws/CameraTrajectory.txt"
